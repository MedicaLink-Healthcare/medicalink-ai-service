...
| 11 | Người lớn tuổi dạo này ăn ngủ kém, muốn bác sĩ nội khoa khám tổng thể kiểm tra sức khỏe | - | SUCCESS | ✅ Passed |
...
| STT | Câu truy vấn (Query) | Phủ định (Negations) | API Status | Kết quả (Result) |
|---|---|---|---|---|
| 1 | Đau thắt ngực trái, mệt mỏi khi leo cầu thang, không ho | không ho | ROUTE_FAILED | ❌ Failed |
...
| 4 | Tôi hay bị nặng ngực, thỉnh thoảng nhói lên từng cơn | - | ROUTE_FAILED | ❌ Failed |
...
| 12 | Tôi bị hở van tim 2 lá nhẹ, nay muốn đi tái khám xem có tiến triển nặng không | - | SUCCESS | ✅ Passed |
...
| 2 | Răng khôn mọc lệch đâm vào má, đau nhức liên tục | - | ROUTE_FAILED | ❌ Failed |
...
| 5 | Chảy máu cam liên tục 2 ngày nay, mỗi lần 1 ít | - | ROUTE_FAILED | ❌ Failed |
| 6 | Tôi bị mất khứu giác, ngửi mùi không thấy rõ, hay nghẹt mũi | - | SUCCESS | ✅ Passed |
| 7 | Tai bên phải có dịch chảy ra mùi hôi, hơi đau tức | - | ROUTE_FAILED | ❌ Failed |
...
| 15 | Tôi muốn cắt amidan vì năm nay viêm sưng 5-6 lần rồi | - | ROUTE_FAILED | ❌ Failed |
...
| 5 | Ăn thức ăn dầu mỡ vào là hay bị đau tức hạ sườn phải | - | SUCCESS | ✅ Passed |
...
| STT | Câu truy vấn (Query) | Phủ định (Negations) | API Status | Kết quả (Result) |
|---|---|---|---|---|
| 1 | Khó thở khi nằm, ho có đờm xanh, có hút thuốc 10 năm | - | ROUTE_FAILED | ❌ Failed |
...
| 8 | Bệnh nhân COPD nay khó thở nhiều hơn, đờm vàng đặc | - | ROUTE_FAILED | ❌ Failed |
...
| 11 | Cứ đêm là ho rũ rượi, ho không kiểm soát được | - | ROUTE_FAILED | ❌ Failed |
...
| 15 | Ho có tiếng rít thanh quản, rát cổ, nuốt đau | - | ROUTE_FAILED | ❌ Failed |
...
| 8 | Nuốt vướng, cảm giác có khối u ở họng, nghẹn khi ăn đồ đặc | - | ROUTE_FAILED | ❌ Failed |
...
| 3 | Nhiều mụn bọc sưng đỏ ở mặt, để lại sẹo rỗ | - | SUGGEST_FAILED | ❌ Failed |
| 4 | Dưới nếp gấp ngực bị đỏ rát, có dịch rỉ ướt, ngứa nhiều | - | SUGGEST_FAILED | ❌ Failed |
| 5 | Kẽ ngón chân bị nứt nẻ, lột da, rất ngứa khi lội nước | - | SUGGEST_FAILED | ❌ Failed |
...
| 14 | Nốt ban đỏ hình đồng tiền nổi ở cổ, ngứa nhiều về đêm | - | ROUTE_FAILED | ❌ Failed |
...
| Tiết niệu | 15 | 11 | **73.3%** |
| Răng Hàm Mặt | 15 | 11 | **73.3%** |
| Tai Mũi Họng | 15 | 11 | **73.3%** |
| Mắt | 15 | 14 | **93.3%** |
| Nhi khoa | 15 | 14 | **93.3%** |
| Tiêu hóa - Gan mật | 15 | 6 | **40.0%** |
...
### Kết luận chung
- **OVERALL ROUTING ACCURACY:** 132/225 (58.7%)
